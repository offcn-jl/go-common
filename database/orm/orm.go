...
import (
	...
	"github.com/offcn-jl/go-common/database"
...
// PostgreSQL 是 PostgreSQL Serverless DB 的 orm 对象
...
func init() {
	dsn := database.GetDSN()
	var err error
	if PostgreSQL, err = gorm.Open("postgres", dsn.PostgreSQL); err != nil {
		logger.Panic(err)
	}
}
